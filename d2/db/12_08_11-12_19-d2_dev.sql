...
SELECT pg_catalog.setval('guides_id_seq', 14, true);
...
SELECT pg_catalog.setval('guides_items_id_seq', 114, true);
...
SELECT pg_catalog.setval('heroes_id_seq', 40, true);
...
40	Zuus	description	zuus_lg.png	default_zuus.txt	npc_dota_hero_zuus
\.
