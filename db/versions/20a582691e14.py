...
def upgrade():
    ...
    add_column(u'items', sa.Column('vendor', sa.String(length=100), nullable=True))
    add_column(u'items', sa.Column('order', sa.Integer(), nullable=True))
    drop_column(u'items', u'category')
...
def downgrade():
    ...
    drop_column(u'items', 'vendor')
    drop_column(u'items', 'order')
    add_column(u'items', sa.Column(u'category', sa.VARCHAR(length=100), nullable=True))
